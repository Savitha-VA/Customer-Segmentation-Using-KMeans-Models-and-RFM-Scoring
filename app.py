...
with open("C:/Users/svkum/OneDrive/Desktop/rfm/segmentation/ml.pkl","rb") as f:
    ml = pickle.load(f)


# Load the processed RFM dataset
rfm = pd.read_csv("rfm_d.csv", index_col=0)

# Normalize the data
rfm_scaled =ml.transform(rfm)
...
selected_option = st.sidebar.radio("Select an option:", ["Overview", "Cluster Insights", "Visualizations","Download Data"])
